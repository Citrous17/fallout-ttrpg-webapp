...
import { UpdateInvoice, DeleteInvoice } from '@/app/ui/combat/buttons';
import { formatDateToLocal, formatCurrency } from '@/app/lib/utils';
import { fetchFilteredEnemies } from '@/app/lib/data';
            ...
            <tbody className="bg-white">
              {enemies?.map((invoice) => (
                ...
                >
                  ...
                  <td className="whitespace-nowrap px-3 py-3">
                    <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={() => addEnemy(invoice)}>
                      Add
                    </button>
                  </td>
                  <td className="whitespace-nowrap px-3 py-3">
