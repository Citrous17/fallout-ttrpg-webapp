  ...
  try {
    ...
    const insertedEnemies = await Promise.all(
      enemies.map((enemy) => {
        ...
        return sql`
          INSERT INTO enemies (id, image_url, name, bodyStat, mindStat, meleeStat, gunsStat, otherStat, initiative, luckPoints, physDR, energyDR, radDR, poisonDR, maxHP, carryWeight, meleeBonus, hp, xp, level, special, defense, attacks, weapons, lootDrops)
